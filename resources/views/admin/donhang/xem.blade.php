...
<div class="card shadow">
    ...
    <div class="card-body">
        @if ($trang_thai == "Đang xử lý")
            <a href="/admin/donhang/duyet/id={{$id_don_hang}}" type="button" class="btn btn-info">Duyệt đơn hàng này</a>
        @endif
        @if ($trang_thai == "Đã xác nhận")
            <a href="/admin/donhang/hoanthanh/id={{$id_don_hang}}" type="button" class="btn btn-success">Hoàn thành đơn hàng này</a>
        @endif
    </div>
</div>

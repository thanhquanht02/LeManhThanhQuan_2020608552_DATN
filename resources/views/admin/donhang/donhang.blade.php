                        ...
                        @foreach ($donhangs as $donhang)
                            @if ($donhang['trang_thai'] != 'Đã hủy' && $donhang['trang_thai'] != 'Đã hoàn thành')
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/donhang/xem/id={{ $donhang['id_don_hang'] }}" type="button"
                                            class="btn btn-btn-primary btn-rounded">Chi tiết</a>
                                        <a href="/admin/donhang/hoanthanh/id={{ $donhang['id_don_hang'] }}" type="button"
                                            class="btn btn-success btn-rounded">Xác nhận</a>
                                        <a href="/admin/donhang/xoa/id={{ $donhang['id_don_hang'] }}"
                                            onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button"
                                            class="btn btn-danger btn-rounded">Hủy</a>
                                    </td>
                                </tr>
                            @endif
                        @endforeach

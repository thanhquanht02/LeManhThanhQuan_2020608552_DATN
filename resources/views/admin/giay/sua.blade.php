            ...
            <div class="table-responsive">
                <form action="/admin/giay/sua" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        <input type="input" class="form-control" name="ten_giay" value="{{ $giay['ten_giay'] }}"
                            required />
                        <label class="form-label">Tên giày</label>
                    </div>

                    <div class="form-outline mb-4">
                        <input type="input" class="form-control" name="ten_loai_giay" list="loai_giay" autocomplete="off"
                    ...
                    <div class="form-outline mb-4">
                        <input type="input" class="form-control" name="ten_thuong_hieu" list="thuong_hieu"
                            autocomplete="off" value="{{ $giay['ten_thuong_hieu'] }}" required />
                    ...
                    <div class="form-outline mb-4">
                        <input type="input" class="form-control" name="so_luong" value="{{ $giay['so_luong'] }}"
                            required />
                    ...
                    <div class="form-outline mb-4">
                        <input type="input" class="form-control" name="ten_khuyen_mai" list="khuyen_mai"
                            autocomplete="off" value="{{ $giay['ten_khuyen_mai'] }}" />

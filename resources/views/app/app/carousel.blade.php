<div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
	...
	<div class="carousel-inner">
		...
		<div class="carousel-item">
			<img src="{{ URL('images1/banner3.jpg') }}" class="d-block w-100" alt="..."/>
			<div class="carousel-caption d-none d-md-block">
				<h5>Storm Shop</h5>
				<p>Chúng tôi luôn cập nhật những mẫu giày mới nhất.</p>
			</div>
		</div>

		<div class="carousel-item">
			<img src="{{ URL('images1/banner4.jpg') }}" class="d-block w-100" alt="..."/>
			<div class="carousel-caption d-none d-md-block">
				<h5>Storm Shop</h5>
				<p>Chúng tôi luôn cập nhật những mẫu giày mới nhất.</p>
			</div>

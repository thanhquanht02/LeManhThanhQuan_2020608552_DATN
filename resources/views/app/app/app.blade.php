...
<head>
    ...
    <title>Storm Shop</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL('images1/logo.jpg') }}">
    <!-- Link -->
...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo.jpg') }}" height="55"
                    alt="Storm Shop" loading="lazy"></a>
            ...
            <a href="/gioi-thieu"><button type="button" class="btn btn-link px-3 me-2">GIỚI THIỆU</button></a>
            <a href="/thanh-toan"><button type="button" class="btn btn-link px-3 me-2">THANH TOÁN</button></a>
            <a href="/gio-hang" data-mdb-toggle="tooltip" data-mdb-placement="bottom" title="Giỏ hàng của bạn"><button
                    type="button" class="btn btn-link px-3 me-2">Giỏ hàng <i
            ...
            <div class="collapse navbar-collapse" id="navbarButtons">
                ...
                <div class="d-flex align-items-center float-right">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    @if (session()->get(key: 'check') == 2)
                                        <li><a class="dropdown-item" href="/lich-su">Đơn hàng</a></li>
                                    @endif
                    ...
                    @else
                        <a class="btn btn-primary btn-rounded" href="{{ route('auth.login') }}">ĐĂNG NHẬP</a>
                        &ensp;
    ...
    <footer class="text-center text-lg-start bg-light text-muted">
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i>Thanh Xuân, Hà Nội</p>
                        <p>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            style="background-color: #253444;">
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center">© 2024 Bản quyền thuộc về:
                    <a class="" href="#">&ensp;Storm Shop</a>
                </span>
            </div>
        </section>
    </footer>
